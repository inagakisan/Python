...
for r, f in sim:
    print(r, ">", f)
    s = '<div style="float:left;"><h3>[差異：' + str(r) + '-' + os.path.basename(f) + ']</h3>' + '<p><a href="' + f + '"><img src="' + f + '" width=400>' + '</a></p></div>'
    html += s
# HTMLを出力
html = """<html><body><h3>元画像</h3><p><img src='{0}' width=400></p>{1}</body></html>""".format(srcfile, html)
